...
int main()
{
    ...
    do
    {
        ...
        do
        {
            ...
            //eseguo l'else if solo se il numero inserito � compreso tra 1 - 31 e diverso da 0
            else if(inputDay != 0 && (inputDay > 0 || inputDay <32))
            {
                //Controllo che il dato inserito non sia gi� stato inserito oppure sia minore del precedente
            ...
            /*Se il numero in input � 0 non deve essere registrato nel vettore,
              ma anche se il controllo sulla scanf � 0;
        ...
        while(inputDay != 0 || check == 0); //Ripeto finch� inputDay � divero da 0 e finch� check � 0
    ...
    while(restart == 'Y'); //Ripeto se il carattere inserito � 'Y'
